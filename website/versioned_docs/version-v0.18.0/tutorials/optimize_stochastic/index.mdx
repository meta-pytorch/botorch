...
<CellOutput>
{
`/var/folders/qq/w_95_j090j74hmlhqzqsgvyh0000gn/T/ipykernel_33620/1334274495.py:8: InputDataWarning: The model inputs are of type torch.float32. It is strongly recommended to use double precision in BoTorch, as this improves both precision and stability and can help avoid numerical errors. See https://github.com/meta-pytorch/botorch/discussions/1444
  model = SingleTaskGP(train_X, train_Y)
...
<CellOutput>
{
`Iteration  15/75 - Loss: -1.001
Iteration  30/75 - Loss: -1.137
Iteration  45/75 - Loss: -1.146
Iteration  60/75 - Loss: -1.148
Iteration  75/75 - Loss: -1.150`
}
</CellOutput>
