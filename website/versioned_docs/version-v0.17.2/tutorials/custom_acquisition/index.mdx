...
<CellOutput>
{
`tensor([0.5301], grad_fn=<MeanBackward1>)`
}
</CellOutput>
...
<CellOutput>
{
`tensor([0.4482, 0.5645], grad_fn=<MeanBackward1>)`
}
</CellOutput>
...
<CellOutput>
{
`tensor([0.5196], grad_fn=<AddBackward0>)`
}
</CellOutput>
...
<CellOutput>
{
`tensor([0.4807, 0.4219, 0.3920], grad_fn=<AddBackward0>)`
}
</CellOutput>
