...
# EM covariance-shrinkage sweep on PD1 arms A and C.
#
# Asks whether nu is better ESTIMATED from the pre-training tasks than fixed by hand.
# The cell list lives in gen_stage_queue.SHRINK; read the comment there before changing
...
say "=== shrink sweep done, $FAILED regime failures ==="
