...
# S32 follow-up sweep: resolve the alpha optimum and dial the whitening ridge.
#
# Asks whether nu is better ESTIMATED from the pre-training tasks than fixed by hand.
# The cell list lives in gen_stage_queue.SHRINK2; read the comment there before changing
...
say "=== shrink2 sweep done, $FAILED regime failures ==="
