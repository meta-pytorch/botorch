...
def transform_intra_point_constraint(
    ...
    d-dimensional space to a d*q-dimensional space.
...
def gen_one_shot_kg_initial_conditions(
    ...
    the maximizer of the posterior objective. Intuitively, the maximizer of the
...
def gen_one_shot_hvkg_initial_conditions(
    ...
    Intuitively, the hypervolume maximizing set of the fantasized posterior mean
    ...
    a hypervolume maximizing set, the ``q`` candidate points are selected using the
...
def gen_value_function_initial_conditions(
    ...
    Intuitively, the maximizer of the fantasized posterior will often be close to a
    maximizer of the current posterior. This function uses that fact to generate the
    initial conditions for the fantasy points. Specifically, a fraction of `1 -
