...
class TestMultiOutputEmpiricalOneDimensionalGP(BotorchTestCase):
    ...
    def _test_coverage_gaps(self) -> None:
        ...
        # exercises the avg_noise=0.0 branch (no noise is added).
        ...
        post_zero_noisy = model_zero.posterior(test_X, observation_noise=True)
        post_zero_clean = model_zero.posterior(test_X, observation_noise=False)
        self.assertAllClose(post_zero_noisy.variance, post_zero_clean.variance)
